...
<body>
    ...
    <div class="main-controls">
        <table>
            <tr>
                <td><center><input type="button" id="colorDetect" value="获取视频流"></center></td> 
                <td><center><input type="button" id="restart" value="重启复位"></center></td> 
            </tr>      
        </table>
    </div>
<div class="container">
  <div class = "row"> 
    <div class = "column"> 
      ...
      <div class="section">
        ...
        <table>
            <tr>
                <td>速率(MHz):&#160;&#160;&#160;<span id="THRESH_MINdemo"></span></td>
